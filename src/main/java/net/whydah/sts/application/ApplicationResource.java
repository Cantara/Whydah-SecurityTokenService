...
public class ApplicationResource {
	...
	public Response validateApplicationTokenId(@PathParam("applicationtokenid") String applicationtokenid) throws AppException {
		...
		if (AuthenticatedApplicationTokenRepository.verifyApplicationTokenId(applicationtokenid)) {
			ApplicationToken token = AuthenticatedApplicationTokenRepository.getApplicationToken(applicationtokenid);
			if(token!=null) {
				log.trace("validateApplicationTokenId - ApplicationTokenId:{} is valid timeout in:{} seconds", 
						applicationtokenid, 
