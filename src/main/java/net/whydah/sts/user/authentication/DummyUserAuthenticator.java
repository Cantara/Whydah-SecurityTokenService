...
public class DummyUserAuthenticator implements UserAuthenticator {
    ...
    public UserToken logonUser(String applicationTokenId, String appTokenXml, String userCredentialXml, long usertookenLifespan) {
        if (ApplicationMode.getApplicationMode().equalsIgnoreCase(ApplicationMode.DEV)) {
            ...
            try {
                ...
                log.info("Could not load dummy sts for username. " + ioe);
            }
	...
	@Override
	public UserToken logonUserUsingSharedSTSSecret(String applicationtokenid, String appTokenXml,
			String adminUserTokenIdparam, String cellPhone, String secret, long userTokenLifespan) {
	...
	@Override
	public UserToken createUserUsingSharedSTSSecret(String applicationtokenid, String appTokenXml,
			String adminUserTokenId, String userjson, String secret, long userTokenLifespan) {
		if (ApplicationMode.getApplicationMode().equalsIgnoreCase(ApplicationMode.DEV)) {
			return new UserToken();
		}
		return null;
